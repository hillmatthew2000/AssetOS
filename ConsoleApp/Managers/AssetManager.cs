...
{
    //Service dependencies for asset and user operations
    private readonly AssetService _assetService;
    private readonly UserService _userService;

    //Constructor to inject required services
    public AssetManager(AssetService assetService, UserService userService)
    {
        _assetService = assetService;
        _userService = userService;
    }

    //Retrieve and display all assets in the system
    public async Task ListAllAssetsAsync()
    {
        Console.WriteLine("\n=== All Assets ===");
    ...
    //Create a new asset by collecting user input
    ...
    //Update all properties of an existing asset
    public async Task UpdateEntireAssetAsync()
    {
        Console.WriteLine("\n=== Update Asset ===");
    ...
    //Update specific properties of an existing asset
    public async Task UpdateSpecificAssetInfoAsync()
    {
        Console.WriteLine("\n=== Update Asset ===");
        Console.Write("Enter Asset ID to update: ");
        ...
        //Switch statement to handle specific property updates
    ...
    //Generate report of assets with expiring warranties
    public async Task WarrantyExpiryReportAsync()
    {
